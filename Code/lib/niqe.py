...
from lib.metric_util import reorder_image, to_y_channel
from lib.matlab_functions import imresize
...
def calculate_niqe(img, crop_border, input_order='CHW', convert_to='y', **kwargs):
    """Calculate NIQE (Natural Image Quality Evaluator) metric.
