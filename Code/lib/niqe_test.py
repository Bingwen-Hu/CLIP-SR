...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default='/opt/data/private/carr/code/saved_models/bird/GALIP_nf64_normal_bird_256_2024_11_26_07_44_56', help='Input path')
