...
from utils import mkdir_p,get_rank,merge_args_yaml,get_time_stamp,save_args
from utils import load_models_opt,save_models_opt,save_models,load_npz,params_count
from perpare import prepare_dataloaders,prepare_models
from modules import sample_one_batch as sample, test as test, train as train
from datasets import get_fix_data
...
def main(args):
    ...
    for epoch in range(start_epoch, args.max_epoch, 1):
        ...
        train(train_dl, netG, netD, netC, text_encoder, image_encoder, optimizerG, optimizerD, scaler_G, scaler_D, writer,args)
        torch.cuda.empty_cache()
        # ==============================================save============================================================
