...
if __name__ == '__main__':
    img_path="/opt/data/private/workspace/GALIP-main/dataset/celeba/CelebAHQ/1.jpg"
    ...
    print(type(single2uint(img_bicubic)))
    image = Image.fromarray(single2uint(img_bicubic))
