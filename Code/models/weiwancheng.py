...
class NetG(nn.Module):
    def __init__(self, ngf, nz, cond_dim, imsize, ch_size, mixed_precision, CLIP):
        ...
        self.swinTrans=SwinTransformerBlock(dim=60,input_resolution=(264,184),num_heads=6,window_size=8,shift_size=4,mlp_ratio=2)
        # 上采样网络
        # self.up = nn.Upsample();
        ##########################################
        ...
        self.absolute_pos_embed = nn.Parameter(torch.zeros(1, 48576, 96))
