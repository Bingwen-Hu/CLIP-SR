...
class GradCAM:
    ...
    def __call__(self, input_tensor, c,target_category=None):

        # 正向传播得到网络输出logits(未经过softmax)
        output = self.activations_and_grads(input_tensor,c)
...
def Init_Setting():
    ...
    path = '/opt/data/private/workspace/GALIP-main/code/saved_models/cele/GALIP_nf64_normal_cele_256_2023_07_31_12_54_16/state_epoch_100.pth'
    # netG=netG.load_state_dict(path)
    # netG = netG.cuda().eval()
    return model


if __name__ == "__main__":
    imgs_path = "/opt/data/private/workspace/GALIP-main/code/samples/LR.png"
    model = Init_Setting()
    ...
    plt.yticks()
    plt.axis('off')
    plt.savefig("/opt/data/private/workspace/GALIP-main/code/samples/gradcam_image.jpg")
