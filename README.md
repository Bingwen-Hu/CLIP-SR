...
This paper has been accepted for publication in IEEE Transactions on Multimedia (TMM 2025). The final version of the paper will be updated once the issue is published.
